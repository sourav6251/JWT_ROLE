...
public class JwtUtil {
    ...
    private static final String secret = "YourBase64EncodedKeyHereYourBase64EncodedKeyHere";
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        SecretKeySpec keySpec = new SecretKeySpec(decodedKey, SignatureAlgorithm.HS256.getJcaName());
